...
document.addEventListener("DOMContentLoaded", function() {
    ...
    <div class="text-center" style="margin-top: -3px;">
        <p class="mb-0 small fw-bold footer-text" style="color: #6c757d;">
            ...
            <span class="text-dark">คณะทำงานขับเคลื่อนระบบคลังสื่อการเรียนรู้เทคโนโลยีดิจิทัล</span> <span class="mx-1 text-muted">x</span> <span class="text-primary">หมอจีPro (AI)</span>
        </p>
